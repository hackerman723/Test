...
Then visit <http://localhost:3000> in a Chromium-based browser, grant microphone permission, and press **Start recording**. The transcript updates in near real-time through `/api/transcribe/live`, and uploaded files are still processed through `/api/transcribe`.
